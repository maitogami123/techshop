...
$routes->add('adminBrands', new Route(constant('URL_SUBFOLDER') . '/admin/brand', array('controller' => 'AdminController', 'method'=>'indexBrandAction'), array()));
$routes->add('createBrands', new Route(constant('URL_SUBFOLDER') . '/admin/brand/create', array('controller' => 'AdminController', 'method'=>'createBrand'), array()));
