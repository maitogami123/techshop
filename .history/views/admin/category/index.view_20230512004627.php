                    ...
                    <tr>
                      ...
                      <td class="table-action">
                        ...
                        <button type="button" class="action-icon btn" data-bs-toggle="modal"
                          ...
                          data-category-id="<?php echo $category->getCategoryID() ?>"><?php echo $category->getCategoryID() ?>
...
$(document).ready(function () {
    $('#change-category').on('shown.bs.modal', function (event) {
      var button = $(event.relatedTarget)
      var categoryId = button.data('category-id')
      $.ajax({
        type: 'get',
        url: `/techshop/admin/category/edit/${categoryId}`,
        success: function (res) {
            console.log(res);
          $('#editModal').html(res);
        }
