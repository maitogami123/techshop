...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2023 at 03:37 AM
...
('MSI_GF65_2', 'Laptop MSI Gaming GF65 Thin 10UE i5 10500H/16GB/512GB/6GB RTX3060 Max-Q/144Hz/Balo/Win10 (286VN)', 'MSI_GF56_268VN.jpg', 29490000, 0, '2023-04-02 13:08:29', NULL, NULL, 'testadmin1', 'MSI', 1),
...
('NH.QAYSV.007', 'Laptop Acer Aspire 7 Gaming A715 42G R05G R5 5500U/8GB/512GB/4GB GTX1650/144Hz/Win11', 'NH.QAYSV.007.jpg', 15990000, 0, '2023-04-19 08:17:26', NULL, NULL, 'testadmin1', 'ACER', 1),
('NX.AM0SV.007', 'Laptop Acer Aspire 3 A315 58 54XF i5 1135G7/8GB/512GB/Win11', 'NX.AM0SV.007.png', 13990000, 0, '2023-04-19 08:03:05', NULL, NULL, 'testadmin1', 'ACER', 1),
('NX.HS5SV.00K', 'Laptop Acer Aspire 3 A315 56 32TP i3 1005G1/4GB/256GB/Win11', 'NX.HS5SV.00K.jpg', 11990000, 0, '2023-04-19 08:29:46', NULL, NULL, 'testadmin1', 'ACER', 1),
('NX.KAGSV.001', 'Laptop Acer Aspire 3 A315 57 379K i3 1005G1/4GB/256GB/Win11', 'NX.KAGSV.001.jpg', 11990000, 0, '2023-04-19 08:14:54', NULL, NULL, 'testadmin1', 'ACER', 1);
...
(12, 'NX.HS5SV.00K', 'CPU:  i31005G11.2GHz'),
(13, 'NX.HS5SV.00K', 'RAM:  4 GBDDR4 (Onboard 4 GB +1 khe rời)2400 MHz'),
(14, 'NX.HS5SV.00K', 'Ổ cứng:  Hỗ trợ khe cắm HDD SATA (nâng cấp tối đa 2 TB)256 GB SSD NVMe PCIe (Có thể tháo ra, lắp thanh khác tối đa 512 GB)');
...
--
ALTER TABLE `productinfo`
  ADD CONSTRAINT `FK_productInfo_product` FOREIGN KEY (`Product_Line`) REFERENCES `product` (`Product_Line`);
