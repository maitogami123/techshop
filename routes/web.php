...
$routes->add('deleteBrand', new Route(constant('URL_SUBFOLDER') . '/admin/brand/delete/{id}', array('controller' => 'BrandController', 'method'=>'deleteAction'), array('id' => '([^&]*)')));

$routes->add('adminCategory', new Route(constant('URL_SUBFOLDER') . '/admin/category', array('controller' => 'AdminController', 'method'=>'indexCategoryAction'), array()));
$routes->add('createCategory', new Route(constant('URL_SUBFOLDER') . '/admin/category/create', array('controller' => 'CategoryController', 'method'=>'createCategory'), array()));
$routes->add('editCategory', new Route(constant('URL_SUBFOLDER') . '/admin/category/edit/{id}', array('controller' => 'CategoryController', 'method'=>'editAction'), array('id' => '([^&]*)')));
