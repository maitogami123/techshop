  ...
  <div class="modal-body">
    ...
    <div class="row g-2 mb-3">
      <div class="col-sm-6">
        ...
        <input class="form-control" type="number" id="product-price" value="<?php echo $product->getPrice() ?>" name='price' />
      </div>
      <div class="col-sm-6">
        <label for="product-discount" class="form-label">Discount</label>
        <input class="form-control" type="number" id="product-discount" value="<?php echo $product->getDiscount() ?>" name='discount'/>
      </div>
    </div>
    <div class="row g-2 mb-3">
      <div class="col-sm-6">
    ...
    <div class="mb-3 modal-footer">
      ...
      <button class="btn btn-primary" type="submit" id="save-change-btn" data-product-id="<?php echo $product->getProductLine() ?>">
        Save change
      </button>
    </div>
  </form>
